...
// Source: github.com/ozoncp/ocp-instruction-api/internal/flusher (interfaces: Flusher)
...
func (m *MockFlusher) Flush(arg0 []models.Instruction) ([]models.Instruction, error) {
	m.ctrl.T.Helper()
