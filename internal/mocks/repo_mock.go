...
// Source: github.com/ozoncp/ocp-instruction-api/internal/repo (interfaces: Repo)
...
import (
	...
	models "github.com/ozoncp/ocp-instruction-api/internal/models"
)
...
func (m *MockRepo) Add(arg0 []models.Instruction) error {
	m.ctrl.T.Helper()
...
func (m *MockRepo) Describe(arg0 uint64) (*models.Instruction, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) List(arg0, arg1 uint64) ([]models.Instruction, error) {
	m.ctrl.T.Helper()
