...
COPY . /home/developer/go/src/github.com/ozoncp/ocp-instruction-api
RUN echo developer | sudo -S chown -R developer /home/developer/

WORKDIR /home/developer/go/src/github.com/ozoncp/ocp-instruction-api
...
WORKDIR /root/
COPY --from=builder /home/developer/go/src/github.com/ozoncp/ocp-instruction-api/bin/ocp-instruction-api .
RUN chown root:root ocp-instruction-api
EXPOSE 80
